...
func (gs *Store) Get(key []byte) (value []byte) {
	...
	fmt.Println("*gaskv.get--", hex.EncodeToString(key), string(key))
...
func (gs *Store) Set(key, value []byte) {
	...
	fmt.Println("*gaskv.set--", hex.EncodeToString(key), string(key), hex.EncodeToString(value), string(value))
}

// Implements KVStore.
func (gs *Store) Has(key []byte) bool {
	gs.gasMeter.ConsumeGas(gs.gasConfig.HasCost, types.GasHasDesc)
	fmt.Println("*gaskv.has--", hex.EncodeToString(key), string(key))
...
func (gs *Store) Delete(key []byte) {
	...
	fmt.Println("*gaskv.delete--", hex.EncodeToString(key), string(key))
}
